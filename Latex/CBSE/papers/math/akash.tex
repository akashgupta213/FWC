...
\includegraphics[width=\linewidth]{iiitb_comet_logo.jpeg}
\end{minipage}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.2\columnwidth]{a.png}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.4\columnwidth]{b.png}
\caption{Line of sight and angle of elevation}
\end{figure}
\begin{enumerate}


\item In this figure, the line AC drawn from the eye of the student to the top of the
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.5\columnwidth]{c.png}
\caption{Angle of elevation}
\end{figure}

   
\item Now, consider the situation given in Fig. 8.2. The girl sitting on the balcony is
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.5\columnwidth]{f.png}
\caption{Angle of elevation}
\end{figure}


\item Now, you may identify the lines of sight, and the angles so formed in Fig. 8.3.
...
\begin{enumerate}
  ...
  \item From a point $P$ on the ground the angle of elevation of the top of a $10$ m tall building
...
of the building from the point $P$. (You may take $\sqrt3 = 1.732$)
  ...
  \vspace{20pt}
  \item  Solution : In Fig. 9.7, $AB$ denotes the height of the building, $BD$ the flagstaff and $P$ the given point. Note that there are two right triangles $PAB$ and $PAD$. We are required to find the length of the flagstaff, i.e., $DB$ and the distance of the building from the point $P$,
i.e., $PA$.
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.45\columnwidth]{d.png}
...
on a level ground is found to be  $40^\circ$  m longer
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.4\columnwidth]{e.png}
...
our head to look at the object.
\item The height or length of an object or the distance between two distant objects.
\end{enumerate}
